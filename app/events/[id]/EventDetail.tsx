"use client" /* Breadcrumb */ /* Main */ /* Ticket picker */ /* Mobile bottom band */ /* Desktop black action rail */
    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: "#FAFAF7" }}>
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 text-center">
          <p className="text-[14px] font-medium" style={{ color: "#111111" }}>
            Event not found.
          </p>
          <Link
            href="/"
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FAFAF7" }}>
      ...
      <div className="border-b bg-white" style={{ borderColor: "#E8E9EB" }}>
        <div
          className="max-w-6xl mx-auto px-6 py-3 flex items-center gap-2 text-[12px]"
          style={{ color: "#292B2F" }}
        >
          ...
          <span>/</span>
          <span className="truncate" style={{ color: "#111111" }}>
            {event.title}
          </span>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 flex gap-8 items-start">
        ...
        <div className="flex-1 min-w-0">
          <div
            className="rounded-lg overflow-hidden bg-gray-100 mb-6"
          ...
          >
            ...
            <p className="text-[14px] mb-4" style={{ color: "#292B2F" }}>
              {event.subtitle}
            </p>
            <div
              className="grid grid-cols-3 gap-6 pt-4 border-t"
              style={{ borderColor: "#E8E9EB" }}
            >
              {[
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              >
                ...
                <span
                  className="font-mono-data text-[13px] font-medium px-3 min-w-[3ch] text-center border-x"
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p
                      ...
                      style={{ opacity: 0.6 }}
                    >
                      Row {sec.row} · Seats {sec.seats}
                    </p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="font-mono-data text-[15px] font-semibold">
          ...
          {}
          <div
            className="md:hidden fixed bottom-0 left-0 right-0 px-5 py-4 z-20"
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                >
                  {section.label} · {qty} ticket{qty > 1 ? "s" : ""}
                </p>
                <span
          ...
          <div className="p-6 flex-1">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p
                  className="text-[11px] font-mono-data mt-0.5"
                  style={{ color: "rgba(250,250,247,0.6)" }}
                >
            ...
            >
              ...
              <div
                className="flex justify-between text-[14px] font-semibold pt-2 border-t"
                style={{ borderColor: "rgba(250,250,247,0.1)" }}
              >
                <span>Total</span>
