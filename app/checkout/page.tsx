...
// Payment fields
/* Header */
/* Confirmation */ /* Left — steps */ /* Card type icons placeholder */ /* Right — persistent order summary (black band) */
...
function CheckoutContent() {
  ...
  const rawEventId = query.get("eventId") ?? "1"
  const eventId = /^\d+$/.test(rawEventId) ? Number(rawEventId) : rawEventId
  const section = query.get("section") ?? "Section 101"
  const row = query.get("row") ?? "C"
  const seats = query.get("seats") ?? "22–23"
  const qty = Number(query.get("qty") ?? 2)
  const priceEach = Number(query.get("price") ?? 212)
  ...
  const handlePay = async (e: React.FormEvent) => {
    ...
    setLoading(false)
    router.push(`/checkout/confirmation?orderId=${orderRef}`)
  }
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FAFAF7" }}>
      ...
      <header className="bg-white border-b" style={{ borderColor: "#E8E9EB" }}>
        <div className="max-w-4xl mx-auto px-6 h-14 flex items-center gap-4">
          <Link
            href="/"
            className="text-[16px] font-bold tracking-tight shrink-0"
            style={{ color: "#111111" }}
          >
            resale
              ...
              <div className="flex items-center gap-3">
                {STEPS.slice(0, 2).map((s, i) => (
                  <div key={s} className="flex items-center gap-2">
                    ...
                    {i < 1 && (
                      <span className="text-[#E8E9EB] mx-1 hidden sm:inline">
                        ›
                      </span>
                    )}
                  </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        {step === 2 ? (
          <div className="max-w-md mx-auto text-center py-12">
            ...
            <p
              className="font-mono-data text-[12px] mb-8"
              style={{ color: "#292B2F" }}
            >
              Order ref: {orderRef}
            </p>
            ...
            <div
              className="border rounded-lg overflow-hidden mb-8 text-left"
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        {
                          label: "Price each",
                          value: `$${priceEach.toLocaleString()}`,
                        },
                      ].map(({ label, value }) => (
                        <div
                          key={label}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[12px]" style={{ color: "#292B2F" }}>
                          Delivered to your email within minutes of purchase.
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              style={{
                                backgroundColor: "#FAFAF7",
                                borderColor: errors.cvv ? "#292B2F" : "#E8E9EB",
                                color: "#111111",
                              }}
                            />
                            {errors.cvv && (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          style={{
                            backgroundColor: "#FAFAF7",
                            borderColor: errors.zip ? "#292B2F" : "#E8E9EB",
                            color: "#111111",
                          }}
                        />
                        {errors.zip && (
              ...
              <div className="p-5">
                ...
                >
                  {[
                    ...
                    {
                      label: `${qty} × $${priceEach.toLocaleString()}`,
                    ...
                    value ? (
                      ...
                      >
                        <span style={{ color: "rgba(250,250,247,0.6)" }}>
                          {label}
                        </span>
                        <span
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono-data text-[16px] font-bold">
